...
public class MovementActivity extends AppCompatActivity {
    ...
    private void dialogShow() {
        ...
        btn_sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MovementActivity.this, VIPCenterActivity.class));
                dialog.dismiss();
            }
        });
    ...
    private void dialogShow3() {
        ...
        btn_sure.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MovementActivity.this, VideoCatchActivity.class));
                dialog.dismiss();
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uri = HttpConstants.HTTP_REQUEST + HttpConstants.MOVEMENT + "/user_id/" + Date.mUserInfo.userid;
        movement.loadUrl(uri);

        movement.getSettings().setJavaScriptEnabled(true);
        movement.getSettings().setRenderPriority(WebSettings.RenderPriority.HIGH);
        WebSettings settings = movement.getSettings();
        settings.setUseWideViewPort(true);
        settings.setLoadWithOverviewMode(true);
        settings.setJavaScriptEnabled(true);
        settings.setSupportZoom(true);
        settings.setDomStorageEnabled(true);
        movement.addJavascriptInterface(new JSInterface(),"Android");
        /***打开本地缓存提供JS调用**/
        movement.getSettings().setDomStorageEnabled(true);
        // Set cache size to 8 mb by default. should be more than enough
        movement.getSettings().setAppCacheMaxSize(1024*1024*8);

        // This next one is crazy. It's the DEFAULT location for your app's cache
        // But it didn't work for me without this line.
        // UPDATE: no hardcoded path. Thanks to Kevin Hawkins
        String appCachePath = getApplicationContext().getCacheDir().getAbsolutePath();
        movement.getSettings().setAppCachePath(appCachePath);
        movement.getSettings().setAllowFileAccess(true);
        movement.getSettings().setAppCacheEnabled(true);
        movement.setWebViewClient(new WebViewClient(){
            @Override
        ...
        movement.setWebChromeClient(new WebChromeClient(){
        ...
        switch (requestCode) {
            ...
            case 99:
                if(requestCode == 99) {
                    ...
                    Log.e("date", "data filepath is " + data.getStringExtra("filepath"));
...
//                    uploadFile(video_path);
    ...
    private void take(){
        ...
        MovementActivity.this.startActivityForResult(chooserIntent,  FILECHOOSER_RESULTCODE);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if(keyCode==KeyEvent.KEYCODE_BACK) {
            if(movement.canGoBack()) {//当webview不是处于第一页面时，返回上一个页面
                movement.goBack();
                return true;
    ...
    public void exit() {
        if ((System.currentTimeMillis() - mExitTime) > 2000) {
            Toast.makeText(MovementActivity.this, "再按一次退出美丽约", Toast.LENGTH_SHORT).show();
...
//        }
        ...
        public void gotoJavaCamera(int type) {
            ...
            Intent intent = new Intent(MovementActivity.this, PhotoPickerActivity.class);
    ...
    void uploadFile(final String path) {
        ...
        mDialog = new SeekProgressDialog(MovementActivity.this);
        mDialog.show();
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    if(res.getInt("code") == 200) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                movement.loadUrl("javascript:getJavaFiles("+"'"+file_path+"'"+")");
                            }
                        });
...
//        //intent.putExtra(MediaStore.EXTRA_SIZE_LIMIT, 1024 * 1024*2L);//限制视频文件大小 以字节为单位
//        //MediaStore.EXTRA_MEDIA_RADIO_CHANNEL
//        intent.putExtra("android.intent.extras.CAMERA_FACING", 1);
        Intent intent = new Intent(MovementActivity.this, VideoRecordActivity.class);
