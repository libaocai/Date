 ...
 */
public class ShilangTabWidget extends LinearLayout implements OnFocusChangeListener {
    ...
    public ShilangTabWidget(Context context) {
        this(context, null);
    }

    public ShilangTabWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShilangTabWidget(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        initTabWidget();
