 ...
 */
public class ShilangTabHost extends FrameLayout implements ViewTreeObserver.OnTouchModeChangeListener {

    private ShilangTabWidget mTabWidget;
    ...
    public ShilangTabHost(Context context) {
        super(context);
        initTabHost();
    }

    public ShilangTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTabHost();
    }
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
      */
    public void setup() {
        mTabWidget = (ShilangTabWidget) findViewById(R.id.tabs);
        if (mTabWidget == null) {
        ...
        mTabWidget.setTabSelectionListener(new ShilangTabWidget.OnTabSelectionChanged() {
    ...
    public ShilangTabWidget getTabWidget() {
        return mTabWidget;
    }
    ...
    public void setCurrentTab(int index) {
        ...
        mCurrentTab = index;
        final ShilangTabHost.TabSpec spec = mTabSpecs.get(index);
