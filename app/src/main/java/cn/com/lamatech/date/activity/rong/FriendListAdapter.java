package cn.com.lamatech.date.activity.rong;
...
//        ImageLoader.getInstance().displayImage(portraitUri, viewHolder.mImageView, App.getOptions());
        ...
        Glide.with(context).load(list.get(position).getPortraitUri().toString()).asBitmap().centerCrop().into(new BitmapImageViewTarget(viewHolder.mImageView) {
            @Override
